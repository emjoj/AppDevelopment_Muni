...
declare function local:create-messenger() {
                ...
                <div class="container-fluid min-vh-100 ">
                    <div class="d-flex flex-row">
                        ...
                        <div class="col-9 min-vh-100 position-relative">
                            ...
                            {local:display-active-conversation()}
...
declare function local:display-messages(){
     for $conversation in doc("db/apps/messenger/messenger.xml")/conversations/conversation
return
                                                    ...
                                                    <div class="col-10">
                                                        <div>
                                                            <div>
                                                                ...
                                                                {data($conversation/message[last()]/@timestamp)}
                                                            ...
                                                            <div>
                                                                ...
                                                                {$conversation/substring(message[last()]/text(),1,10)}
...
declare function local:display-active-conversation() {
 ...
 where $conversation/@isActive='True'
    return(
        ...
        <div class="col-10">
            ...
            {
                local:display-active-conversation-messages($conversation)
            }
...
declare function local:display-active-conversation-messages($conversation){
